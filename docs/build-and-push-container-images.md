...
```bash
# Build the ghcr.io/paulbouwer/hello-kubernetes:$version image
make build-image-linux

# Build the ghcr.io/paulbouwer/hello-kubernetes:$version image
export REGISTRY=ghcr.io
export REPOSITORY=paulbouwer
make build-image-linux
```
...
```bash
# Push ghcr.io/paulbouwer/hello-kubernetes:$version.
...
#   - ghcr.io/paulbouwer/hello-kubernetes:1.10.0
#   - ghcr.io/paulbouwer/hello-kubernetes:1.10
#   - ghcr.io/paulbouwer/hello-kubernetes:1
make push-image

# REGISTRY=ghcr.io
# REPOSITORY=paulbouwer
# Push ghcr.io/paulbouwer/hello-kubernetes:$version to ghcr.io.
# Will tag $majorversion and $majorversion.$minorversion.
#
# Example: The container image will be tagged as follows for $version=1.10.0
#   - ghcr.io/paulbouwer/hello-kubernetes:1.10.0
